...
const KEYWORD_GUESSES = [
  ...
  // The vehicle-maintenance line was folded into personal money, so repairs
  // land in household spending until the family adds the category back.
  { match: /AUTOZONE|O ?REILLY|ADVANCE AUTO|NAPA|TIRE|JIFFY LUBE|VALVOLINE|CAR WASH|PARTS|AUTO TITLE|OH BUREAU|\bBMV\b|HOPETOWN/, category: 'Household & misc' },
